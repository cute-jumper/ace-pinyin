...
* Disable Word Jumping Support
  By default, =ace-pinyin= allows you to jump to Chinese characters no matter
  you use character jumping or (sub)word jumping commands. However, you can disable
  word jumping support by:
